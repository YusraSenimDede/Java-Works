...
public class Idman {
    ...
    private int pushup_sayisi;//şınav sayısı
    private int situp_sayisi;//mekik sayısı
...
//getter setter
    ...
    //main javanın içinde bir while true dongusu olusturacaz
    //idmanımız bitene kadar bizim bu döngümüzden cıkmıcaz yani döngümüz sonlanmayacak
    //kontrol yappmam lazım
    //metod yazmam lazım
    //hiçbir hareketimiz kalmadıysa yapacak bişeyimiz kalmadıysa burada true deger döndüreceğiz
    //belli hareketlerimiz kaldıysa buradan false deger döndüreceğiz
