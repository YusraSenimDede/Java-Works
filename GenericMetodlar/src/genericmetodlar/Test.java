...
public class Test {
    public static void main(String[] args) {
        ...
        System.out.println("Birinci SayÄ±sal Ã–ÄŸrencinin PuanÄ±: " + birinci.puanHesapla());
        System.out.println("Birinci EÅŸit AÄŸÄ±rlÄ±k Ã–ÄŸrencinin PuanÄ±: " + birinci2.puanHesapla());
