...
public class Test {
    ...
    public static void main(String[] args) {
        Resolution resolution = new Resolution(1920, 1080);//bellekte calıstırdıgımız zaman bir tane resolution objesi olacak
//resolution objesini monitor objesinin içerisine yerleştirmemiz lazım
